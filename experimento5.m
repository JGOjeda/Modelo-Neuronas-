...
%currentLevels =randn(1,tiempo)+2.231;
...
%I(5000:5500)= randn(1,length (I(5000:5500)))+25;%50; %<<<<<<<<<<<<<<---------------VIBRISA
figure(f1) 
plot(t,I)
