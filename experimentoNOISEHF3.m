...
% los experimetos 
% 
N=3.5;% input('Escribe los minutos de estimulacion:');
...
NM=3.5;%2;% input('Escribe los minutos de estimulacion:');
% High frequency current stimulation 
A = 0.5; %asintota inferior 
K = 2.5; %asintota superior 
B = 0.8; % tasa de crecimiento 
...
% Zona  con minutos TRATAMIENTO
N=3.5;%2;%;% input('Escribe los minutos de estimulacion:');
% High frequency current stimulation 
A = 0.5; %asintota inferior 
K = 2.5; %asintota superior 
B = 0.8; % tasa de crecimiento 
...
% Zona  con minutos TRATAMIENTO
N=3.5;%4 para todos los casos incluso 2 mmin y 10 min;% input('Escribe los minutos de estimulacion:');
% High frequency current stimulation 
A = 0.5; %asintota inferior 
K = 2.5; %asintota superior 
