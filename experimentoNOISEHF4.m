function experimentoNOISEHF4


contadorT=1;
while contadorT<=2; 
    close all 
clear  HE FS HSST  HVIP


% Zona  con minutos TRATAMIENTO        este script es el bueno para simular
% los experimetos 
% 
N= 3;% input('Escribe los minutos de estimulacion:');
...
NM= 5;% input('Escribe los minutos de estimulacion:');
% High frequency current stimulation 
A = 0.5; %asintota inferior 
K = 2.5; %asintota superior 
B = 0.8; % tasa de crecimiento 
...
% Zona  con minutos TRATAMIENTO
N= 5;% input('Escribe los minutos de estimulacion:');
% High frequency current stimulation 
A = 0.5; %asintota inferior 
K = 2.5; %asintota superior 
B = 0.8; % tasa de crecimiento 
...
% Zona  con minutos TRATAMIENTO
N= 4;% input('Escribe los minutos de estimulacion:');
% High frequency current stimulation 
A = 0.5; %asintota inferior 
K = 2.5; %asintota superior 
B = 0.8; % tasa de crecimiento 
